...
Ethernet and InfiniBand are the most prevalent communication technologies in data centers and \ac{HPC} environments (\Cref{fig:introduction:Interconnect_Technologies_500_supercomp}). 
