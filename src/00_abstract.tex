...
% The flow of packets in tunneling is comparable to the movement of vehicles through a tunnel, hence the analogy. 
...
As the result, the tunnel can serve as a proof of concept and lay the groundwork for further research on algorithms and protocols, as well as applications such as overhauling the 5G core network. \todo{review: this is the abstract for the proposal. I have no data to back the claim (better throughput, ... as suggested), so I feel more comfortable leaving only  the vision of the project like this}
